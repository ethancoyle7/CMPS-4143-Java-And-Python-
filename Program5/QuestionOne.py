...
# to do this, we will create a constructor, a getter and a setter 
# method and then we will create another class calle Stack which 
# will implement parsing and removing and adding nodes that will
