...
//   The string and find the % most occured words inside of the string, In doing, We will   //
//   Store the occured words in an array and then run through some tests and then output to //
